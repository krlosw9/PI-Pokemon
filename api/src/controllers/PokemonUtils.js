...
const LIMIT_API = 40;//Este limite lo coloca el readme de henry, solo se pueden traer de la api 40 pokemon
...
const getAllPokemonApi = async() =>{
  ...
  const apiResponse = await axios.get(`https://pokeapi.co/api/v2/pokemon/?limit=${LIMIT_API}`);
